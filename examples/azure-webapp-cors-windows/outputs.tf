...
output "service_plan_name" {
  ...
  value       = module.webapp_cors.service_plan_name
}
...
output "vnet_integration_connection_id" {
  description = "ID of the regional VNet integration connection."
  value       = module.webapp_cors.vnet_integration_connection_id
}
...
output "custom_domain_binding_id" {
  description = "ID of the custom hostname binding (null when no custom domain)."
  value       = module.webapp_cors.custom_domain_binding_id
}

output "certificate_thumbprint" {
  description = "Thumbprint of the TLS certificate bound to the custom domain (null when no certificate)."
  value       = module.webapp_cors.certificate_thumbprint
}
...
output "application_insights_connection_string" {
  description = "Connection string of the Application Insights instance (null when monitoring is disabled)."
  value       = module.webapp_cors.application_insights_connection_string
}
...
output "action_group_id" {
  description = "ID of the alert action group (null when no email addresses are configured)."
  value       = module.webapp_cors.action_group_id
}
