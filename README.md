...
| [`modules/azure-webapp-cors`](modules/azure-webapp-cors) | Azure | App Service (Linux web app) with CORS allowed origins configured via `azapi` |
...
| [`examples/azure-webapp-cors`](examples/azure-webapp-cors) | Deploys the Azure web app module with a restrictive CORS origin list |
